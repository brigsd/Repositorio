...
export const EXERCICIOS_A3: ExercicioGerado[] = [
...

  {
    ...
    feedbackErro: [
      ...
      "A resposta é **'Não pode prorrogar.'** sem vírgula. Você está dizendo que a prorrogação não é permitida. É uma proibição direta.",
    ],
  },
...

  {
    ...
    feedbackErro: [
      ...
      "A resposta é **'Não haverá reunião.'** sem vírgula. É um aviso direto de cancelamento.",
    ],
  },
...

  {
    ...
    feedbackErro: [
      ...
      "A resposta é **'Não pode usar a área de lazer.'** sem vírgula. É proibição direta.",
    ],
  },
