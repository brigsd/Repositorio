# 03 — Nível A: Da escrita informal à escrita formal

**Duração total estimada:** ~4-5 horas de trabalho do aluno, distribuídas no ritmo dele.
**Estrutura:** 10 unidades de 20-30 min cada.

## Princípio do nível

> O aluno já escreve. Aqui afiamos para a hora que importa.
...
Mostrar três cenas reais:
- Currículo com erro de concordância → não foi chamado pra entrevista
- E-mail informal demais pro chefe → ficou marcado como "não leva a sério"
- Cláusula de contrato mal interpretada → assinou algo ruim

**Mensagem:** "Você já sabe escrever. Aqui vamos afiar pra hora que importa."
...
## Rubrica do projeto integrador (Unidade 10)

| Critério | Atende? |
|---|---|
| Registro adequado ao destinatário | sim/parcial/não |
| Pontuação clara e correta | sim/parcial/não |
| Ortografia (acentos) | sim/parcial/não |
| Sem confusões de palavras (mas/mais, há/a, etc.) | sim/parcial/não |
| Concordância verbal e nominal | sim/parcial/não |
| Regência nos casos cobertos | sim/parcial/não |
| Estrutura coerente (abertura, corpo, fecho) | sim/parcial/não |
| Tom adequado (educado, sem ofender, sem submissão) | sim/parcial/não |

**Critério de aprovação:** todos "sim" ou no máximo 1 "parcial" com revisão.

## Lógica de avanço entre unidades

- Não passa de unidade sem atender o critério
- **Mas** pode pedir "mais prática" quantas vezes quiser
- Se errar muito, IA detecta padrão do erro e oferece micro-revisão antes de tentar de novo
- Tempo entre unidades é livre — o aluno volta quando der

## Divisão curador × IA

**O curador cura uma vez:**
...
- Cria contextos personalizados por aluno (universo profissional/pessoal)
- Dá feedback em cada resposta
- Detecta padrão de erro e sugere revisão
- Avalia o projeto integrador pela rubrica

## Riscos específicos deste nível e como mitigamos
